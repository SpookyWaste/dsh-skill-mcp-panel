...
import { foldWorkspaces } from "./workspaces.js";
...
class SkillsViewerGateway extends TypertRemoteService {
    ...
    async enumerateWorkspaces() {
        const rows = [];
        const collect = async (path, title, sessions) => {
            if (typeof path !== "string" || path === "")
                return;
        ...
        try {
            ...
            if (registry !== undefined && typeof registry.list === "function") {
                for (const workspace of registry.list()) {
                    ...
                    await collect(workspace.path, typeof workspace.title === "string" ? workspace.title : undefined, Array.isArray(workspace.sessionIds) ? workspace.sessionIds.length : 0);
                }
            }
        }
        catch {
